...
class ModelArguments:
    model_name_or_path: Optional[str] = field(default="/home/zikaixiao/zikaixiao/llmmemo/Llama2-7b-chat")
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    output_dir: str = field(default="./output_qlora_tinyllama")
    num_train_epochs: int = field(default=5)        # 1
