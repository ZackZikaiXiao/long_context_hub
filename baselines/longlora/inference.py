...
def parse_config():
    ...
    parser.add_argument('--material', type=str, default="/home/zikaixiao/zikaixiao/LongLoRA-main/benchmarks/test.txt")
    parser.add_argument('--question', type=str, default="Where was the wife of Francis I Rákóczi born?")
    parser.add_argument('--base_model', type=str, default="/home/zikaixiao/zikaixiao/LongLoRA-main/TinyLlama-1.1B-Chat-v1.0-merged")
    parser.add_argument('--cache_dir', type=str, default="./cache")
    parser.add_argument('--context_size', type=int, default=8192 * 1, help='context size during fine-tuning')
    parser.add_argument('--flash_attn', type=bool, default=True, help='')
    parser.add_argument('--temperature', type=float, default=0.6, help='')
    parser.add_argument('--top_p', type=float, default=0.9, help='')
    parser.add_argument('--max_gen_len', type=int, default=100, help='')
