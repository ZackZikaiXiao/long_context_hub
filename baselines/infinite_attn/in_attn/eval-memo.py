...
def parse_config():
    ...
    parser.add_argument('--context_size', type=int, default=16384, help='context size during fine-tuning') # -1
    parser.add_argument('--peft_model', type=str, default=None, help='')
    parser.add_argument('--flash_attn', type=bool, default=True, help='')
    parser.add_argument('--data_path', type=str, default="./pg19/test.bin", help='')
