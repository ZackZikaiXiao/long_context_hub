...
import attention.LongLM.self_extend_patch as SE
...
def apply(loaded_model, group_size, window_size, enable_flash_attention=False, scale_base=4096, flash_attention_impl="flash_attn"):
    '''
        loaded_model: 
