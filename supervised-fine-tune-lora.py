...
replace_upsampling_enable = True
def load_and_resample_dataset(data_path: str) -> list:
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    output_dir: str = field(default="./TinyLlama-1.1B-16k-ft-sft-lora-resampling")
...
class SupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str, tokenizer: transformers.PreTrainedTokenizer):
        ...
        list_data_dict, sample_weights = load_and_resample_dataset(data_path)
...
def train():
    ...
    model = transformers.AutoModelForCausalLM.from_pretrained(
        ...
        config=config,
        cache_dir=training_args.cache_dir,
        torch_dtype=torch.bfloat16,     # torch.float32, bfloat16, float16 for 8bit loading
