...
ROOT_DIR="/home/zikaixiao/zikaixiao/LongLoRA-main/benchmark/RULER" # the path that stores generated task samples and model predictions.
MODEL_DIR="/home/zikaixiao/zikaixiao/LongLoRA-main/models" # the path that contains individual model folders from HUggingface.
