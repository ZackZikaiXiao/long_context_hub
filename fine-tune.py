...
class TrainingArguments(transformers.TrainingArguments):
    ...
    # output_dir: str = field(default="./TinyLlama-1.1B-16k-ft")
    output_dir: str = field(default="./TinyLlama-1.1B-16k-ft")
...
def train():
    ...
    print("Loading model ...")
    dataset = load_dataset(data_args.data_path, cache_dir=training_args.cache_dir)
    print("Loading model ... sucessfully.")
    ...
    print("Dataset tokenizing ... sucessfully.")
